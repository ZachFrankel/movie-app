...
export function MediaCard({ posterPath, title, mediaType, year }: MediaCardProps) {
  ...
  return (
    <div className="group -m-3 mb-3 rounded-xl bg-background-main bg-opacity-0 transition-colors duration-100 hover:bg-opacity-100">
      <article className="pointer-events-auto relative mb-2 p-3 transition-transform duration-100 group-hover:scale-95">
        ...
        <h1 className="mb-1 line-clamp-3 max-h-[5rem] text-ellipsis break-words font-semibold text-white text-left">
          {title}
        </h1>
